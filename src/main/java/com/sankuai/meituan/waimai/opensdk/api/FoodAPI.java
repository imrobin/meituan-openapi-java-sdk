...
public class FoodAPI extends API{
     ...
     * @return
     */
    public List<FoodParam> foodList(SystemParam systemParam,String appPoiCode)
...
//        System.out.println(data);
     ...
     * @return
     */
    public List<FoodParam> foodListByPage(SystemParam systemParam,String appPoiCode, int offset, int limit)
        throws ApiOpException, ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @return
     */
    public String foodCatUpdate(SystemParam systemParam, String appPoiCode,
     ...
     * @return
     */
    public List<FoodCatParam> foodCatList(SystemParam systemParam,String appPoiCode)
        throws ApiOpException, ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @return
     */
    public String foodCatDelete(SystemParam systemParam, String appPoiCode,
     ...
     * @return
     */
    public String foodSave(SystemParam systemParam, FoodParam foodParam) throws ApiOpException,
                                                                                        ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @return
     */
    public String foodBatchSave(SystemParam systemParam, String appPoiCode,
     ...
     * @return
     */
    public String foodInitData(SystemParam systemParam , FoodParam foodParam)
        throws ApiOpException, ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
     ...
     * @return
     */
    public String foodBatchInitData(SystemParam systemParam, String appPoiCode,
     ...
     * @return
     */
    public String foodDelete(SystemParam systemParam, String appPoiCode,
     ...
     * @return
     */
    public String foodSkuSave(SystemParam systemParam, String app_poi_code,String app_food_code,List<FoodSkuParam> foodSkuParams)
        throws ApiOpException, ApiSysException {
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
...
//        Map<String,String> applicationParamsMap = ConvertUtil.convertToMap(foodSkuParams);
     ...
     * @return
     */
    public String foodSkuDelete(SystemParam systemParam, String appPoiCode, String appFoodCode,
     ...
     * @return
     */
    public String updateFoodSkuPrice(SystemParam systemParam, String appPoiCode,
     ...
     * @return
     */
    public String updateFoodSkuStock(SystemParam systemParam, String appPoiCode,
     ...
     * @return
     */
    public String incFoodSkuStock(SystemParam systemParam, String appPoiCode,
                                  List<FoodSkuStockParam> foodSkuStockParams)
    throws ApiOpException, ApiSysException{
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
        beforeMethod(null, systemParam, appPoiCode, JSONObject.toJSONString(foodSkuStockParams));
     ...
     * @return
     */
    public String descFoodSkuStock(SystemParam systemParam, String appPoiCode,
                                  List<FoodSkuStockParam> foodSkuStockParams)
            throws ApiOpException, ApiSysException{
        String methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
        beforeMethod(null, systemParam, appPoiCode, JSONObject.toJSONString(foodSkuStockParams));
